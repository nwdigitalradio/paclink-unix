...
#define PLU_MAJOR_VERSION   0
#define PLU_MINOR_VERSION   5
#define PLU_BUILD           0

#define PLU_VERSION_STRING \
    __STRING(PLU_MAJOR_VERSION) \
    "." \
    __STRING(PLU_MINOR_VERSION)\
    "("__STRING(PLU_FLASH_BUILD)")"
